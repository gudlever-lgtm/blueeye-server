...
// Similarity scoring for events — simple weighted matching, NOT ML. Given a
// target event and a pool of past resolved/closed events, score each by
...
function scoreSimilarEvents(target, candidates, { weights = DEFAULT_WEIGHTS, limit = 5 } = {}) {
...
module.exports = { scoreSimilarEvents, DEFAULT_WEIGHTS };
