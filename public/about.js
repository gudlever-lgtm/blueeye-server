...
(function (root) {
  ...
  var RELEASES = [
    { v: '0.169.0', d: '2026-09-20', area: 'platform',
    ...
    { v: '0.169.0', d: '2026-09-20', area: 'insights',
      en: { t: 'Capacity forecast: which link runs out of room first', s: 'Every interface projected against its own negotiated speed, with the days until it saturates. It reads two weeks of the link\u2019s own utilisation, so the answer is the link\u2019s history, not a number anybody had to type into a settings screen.' },
      da: { t: 'Kapacitetsprognose: hvilket link l\u00f8ber f\u00f8rst t\u00f8r', s: 'Hvert interface fremskrevet mod sin egen forhandlede hastighed, med antal dage til det er m\u00e6ttet. Den l\u00e6ser to ugers udnyttelse fra linket selv, s\u00e5 svaret er linkets historik \u2014 ikke et tal, nogen skulle taste ind under indstillinger.' } },
    { v: '0.169.0', d: '2026-09-20', area: 'assurance',
      en: { t: 'Alerts can go to a Matrix room', s: 'A room on your own homeserver, beside e-mail, webhook and syslog. Email is where alerts go to be missed and a webhook needs someone to build the other end \u2014 a room is where the people who fix this already are, and it never leaves your network.' },
      da: { t: 'Alarmer kan sendes til et Matrix-rum', s: 'Et rum p\u00e5 jeres egen homeserver, ved siden af e-mail, webhook og syslog. Mail er der, hvor alarmer bliver overset, og en webhook kr\u00e6ver, at nogen bygger modtagersiden \u2014 et rum er der, hvor de, der retter fejlen, allerede er. Og det forlader aldrig jeres netv\u00e6rk.' } },
    { v: '0.169.0', d: '2026-09-20', area: 'platform',
      en: { t: 'The map library is served from your own server', s: 'Leaflet used to load from a CDN, which meant an air-gapped install quietly lost its maps and a third party could run code in the dashboard. It ships with the server now, and the security policy no longer allows any outside script at all.' },
      da: { t: 'Kortbiblioteket leveres fra jeres egen server', s: 'Leaflet blev f\u00f8r hentet fra et CDN, hvilket betød, at en installation uden internetadgang stille mistede sine kort, og at en tredjepart kunne k\u00f8re kode i dashboardet. Nu f\u00f8lger det med serveren, og sikkerhedspolitikken tillader slet ingen eksterne scripts.' } },
    { v: '0.169.0', d: '2026-09-20', area: 'fleet',
      en: { t: 'Re-pinning an agent now has to be signed', s: 'A rekey replaces the key every later update is checked against, so an unsigned one turned a single moment of access into lasting trust. A legitimate rotation is signed with the key it replaces; recovering a fleet whose server lost its key now takes access to the host, as it should.' },
      da: { t: 'Fastl\u00e5sning af en agent skal nu v\u00e6re signeret', s: 'En rekey udskifter den n\u00f8gle, alle senere opdateringer tjekkes mod, s\u00e5 en usigneret gjorde ét \u00f8jebliks adgang til varig tillid. En \u00e6gte rotation signeres med den n\u00f8gle, den erstatter; at redde en flåde, hvis server har mistet sin n\u00f8gle, kr\u00e6ver nu adgang til maskinen — som det b\u00f8r.' } },
    { v: '0.169.0', d: '2026-09-20', area: 'platform',
      en: { t: 'Failures that used to be invisible now say something', s: 'A directory that cannot be read, a licence that cannot be fetched, a blast radius that could not be computed \u2014 each of these used to look exactly like a normal, empty answer. They are logged now, and the screen says which one it is.' },
      da: { t: 'Fejl, der f\u00f8r var usynlige, siger nu noget', s: 'Et katalog, der ikke kan l\u00e6ses, en licens, der ikke kan hentes, en konsekvensanalyse, der ikke kunne beregnes \u2014 alle tre lignede f\u00f8r et helt normalt tomt svar. De logges nu, og sk\u00e6rmen siger, hvad der er sket.' } },
