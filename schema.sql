...
CREATE TABLE IF NOT EXISTS `agent_command_queue` (
  ...
  CONSTRAINT `fk_agent_command_agent` FOREIGN KEY (`agent_id`) REFERENCES `agents` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `agent_health_acks` (
  ...
  `acked_at` DATETIME(3) NOT NULL,
  PRIMARY KEY (`agent_id`),
  CONSTRAINT `fk_agent_health_acks_agent` FOREIGN KEY (`agent_id`) REFERENCES `agents` (`id`) ON DELETE CASCADE,
  KEY `idx_agent_health_acks_user` (`acked_by`),
  CONSTRAINT `fk_agent_health_acks_user` FOREIGN KEY (`acked_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
