...
(function (root) {
  ...
  var STRINGS = {
    en: {
      ...
      'sa.test.noWorker': 'No worker is connected, so this run will wait. See the documentation for how to start one.',
    ...
    da: {
      ...
      'sa.test.noWorker': 'Der er ingen worker forbundet, så kørslen venter. Se dokumentationen for at starte en.',
