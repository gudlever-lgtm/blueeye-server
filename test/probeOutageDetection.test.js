...
const { evaluateRow, deriveSequenceState, groupRows } = require('../src/probeOutages/detection');
...
test('an open outage closes when a result returns under threshold', () => {
  const rows = [
