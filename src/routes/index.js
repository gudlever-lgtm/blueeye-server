...
function createApiRouter({
  ...
  router.use('/agents', createAgentsRouter({ agentsRepo, locationsRepo, resultsRepo, agentCommander, agentSourceStore, releaseStore, releasePublicKey, publishRelease: () => publishSignedReleaseFromSource({ sourceStore: agentSourceStore, releaseStore, releaseKeyService }), auditRepo, auditLogger, integrationTrigger: integrationsDispatcher, commandSigner, logger, reconnect: agentReconnect }));
