    ...
    section: 'Troubleshooting how-tos', admin: false, articles: [
      {
        id: 'assurance', title: 'Watch a web service with Service Assurance', body: () => [
          ...
          el('p', { class: 'muted' }, 'Some applications refuse to load scripts from anywhere but themselves (a Content-Security-Policy). On those, the bookmark does nothing and says so — build the test in the designer instead. The recording also expires, usually within 30 minutes, so the key in the bookmark is worth nothing afterwards.'),
