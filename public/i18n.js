...
(function (root) {
  ...
  var STRINGS = {
    en: {
      ...
      'sa.top.title': 'Applications with the most critical incidents',
      'sa.top.help': 'Counted by when the incident opened, so a problem that was fixed inside the period still counts towards it.',
    ...
    da: {
      ...
      'sa.top.title': 'Applikationer med flest kritiske hændelser',
      'sa.top.help': 'Talt efter hvornår hændelsen opstod, så et problem der blev løst inden for perioden tæller stadig med i den.',
