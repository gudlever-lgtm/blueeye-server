...
const { KINDS } = require('../repositories/eventNotesRepository');
...
// Validates the POST /api/events/:id/notes body: { text, kind }.
//
...
function validateEventNote(body) {
  const errors = [];
...
module.exports = { validateEventNote, TEXT_MAX };
